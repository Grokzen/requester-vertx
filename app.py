...
vertx.deploy_module('io.vertx~mod-mongo-persistor~2.0.0-beta2', handler=deploy_handler)

# Start the web server, with the config we defined above
vertx.deploy_module('io.vertx~mod-web-server~2.0.0-beta2', web_server_conf)
